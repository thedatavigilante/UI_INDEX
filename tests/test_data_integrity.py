...
# (employer_contribution_gap.json now has _metadata wrapper — Roadmap #30 done.)
METADATA_FILES = [
...
# All 13 expected figures (01-08 forensic/economic, 09-10 context/accountability, 11-13 FEC)
FIGURES_EXPECTED = [
        "01_bai_decay_trajectory",
        "02_wbi_stagnation",
        "03_mipi_clawback",
        "04_housing_vs_wba_gap",
        "05_employer_per_employee_gap",
        "06_employer_aggregate_gap",
        "07_statutory_vs_expected_wage_base",
        "08_real_value_index",
        "09_unemployment_context",
        "10_spending_accountability",
        "11_fec_total_receipts",
        "12_fec_business_vs_labor",
        "13_fec_contribution_mix",
]
