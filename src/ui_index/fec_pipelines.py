...
if not KEY:
    # REQUIRE_API_KEY (any non-empty value) hard-fails when FEC_API_KEY is absent —
    # set it in the data-refresh CI to prevent silent DEMO_KEY rate-limit data corruption.
